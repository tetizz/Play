Create one horizontal animation strip for Codex pet `mubbi`, state `running-right`.
...
Identity: same pet in every frame: A compact whole-body pet mascot inspired by a practical builder working on bots: rounded teal-and-coral soft toy body, tiny antenna headphones, expressive dark eyes, little tool-satchel shape integrated into the body, friendly focused posture, no readable text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: polished soft vinyl toy, readable at 192x208, bright but restrained palette, no text, no logos, no shadows.
