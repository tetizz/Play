Create one horizontal animation strip for Codex pet `pawnsy`, state `running-right`.
...
Identity: same pet in every frame: A compact whole-body talking black chess pawn mascot: glossy obsidian pawn body, simple carved expressive face with bright eyes and small mouth, tiny mitten-like hands, confident friendly strategist personality, no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: polished black chess-piece toy, readable at 192x208, subtle charcoal highlights, expressive face, no text, no logos, no shadows.
