...
Engine::Engine(std::optional<std::string> path) :
    ...
    options.add("BadMannersMode", Option("Off Safe Aggressive Maximum Puzzle", "Off"));
    options.add("KBNMateChallenge", Option(true));
    options.add("RequirePureKBNFinal", Option(true));
    options.add("PromoteMissingMinor", Option(true));
    options.add("SacrificeAllOtherPieces", Option(true));
    options.add("PreserveForcedWin", Option(true));
    options.add("PreferForcedSacrifices", Option(true));
    options.add("UseKBNTablebase", Option(true));
    options.add("KBNVerificationDepth", Option(16, 1, 64));
    options.add("ChallengeVerificationDepth", Option(4, 1, 16));
    options.add("CompleteKBNVerificationDepth", Option(2, 1, 64));
    options.add("ChallengePlanningDepth", Option(14, 1, 64));
    options.add("MinimumSafeEvaluation", Option(500, 0, 10000));
    options.add("AllowMateDelay", Option(true));
    options.add("MaximumAllowedMateDelay", Option(20, 0, 200));
    options.add("RespectFiftyMoveRule", Option(true));
    options.add("VerboseChallengeOutput", Option(false));
